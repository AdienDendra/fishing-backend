...
TARGETS=("lambda_functions/weather_processor" "lambda_functions/weather_activity" 
"lambda_functions/weather_handler" "lambda_functions/weather_analysis")
...
for target in "${TARGETS[@]}"; do
    ...
    cp "$SHARED/weather_cache_pipeline.py" "$target/"
